...
# =============================================================================
cc_weights_factor = [1.9]  # [2.5]  # [2.]  # [1.0]
cc_weights_I_factor = [2.]  # [2.1, 2.2]  # [2.1, 2.2, 2.3, 2.4]  # [2.5, 3.]
Q = 1
        ...
        for cc_scaling in cc_weights_factor:
            for cc_I_scaling in cc_weights_I_factor:
                for j_e_plus in J_E_PLUS:
                    ...
                    # |         |       dt_trial        |       dt_trial        |
                    # | dt_init | dt_offset |           | dt_offset |           |
                    #                       ^
                    #                  stimulation
                    dt_init = 500.  # Time for initial transients, in ms
                    dt_offset = 500.  # Time after which stimulation is applied
                    dt_trial = 2000.
                    # T = 100500
                    number_of_rounds = 50  # 1 + int((T-dt_init) / dt_trial) # Assumes simulation time T = 100500 ms
                    ...
                    for i in range(number_of_rounds):
                        ...
                        stim_on = dt_init + i * dt_trial + dt_offset
